...
class WeiboSpider(CrawlSpider):
    ...
    start_urls = ['https://weibo.com/p/10080854d3a21ee5b8a15d2004b7350bf67e6d?from=faxian_huati&mod=mfenlei']
    ...
    def parse_item(self, response):
        ...
        处理items
        '''
        selector = Selector(text=response.body.decode(encoding='utf-8'))
        print(selector.xpath('//div[@class="WB_text*"]'))
